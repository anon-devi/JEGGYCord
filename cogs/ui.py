...
role_ids = [997072356902182932, 997073159461294130, 997073679936667678, 997071996863139910]
...
class ButtonRoleCog(commands.Cog):
    ...
    @commands.slash_command(guild_ids=[931791681102180422], description="Post the button role message")
